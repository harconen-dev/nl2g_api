...
# Models
require 'swagger_client/models/api_response_delete'
require 'swagger_client/models/api_response_post'
require 'swagger_client/models/attribute_get'
require 'swagger_client/models/attribute_patch'
require 'swagger_client/models/attribute_post'
require 'swagger_client/models/attribute_response'
require 'swagger_client/models/company_get'
require 'swagger_client/models/company_patch'
require 'swagger_client/models/company_response'
require 'swagger_client/models/data'
require 'swagger_client/models/error'
require 'swagger_client/models/group_get'
require 'swagger_client/models/group_patch'
require 'swagger_client/models/group_post'
require 'swagger_client/models/group_response'
require 'swagger_client/models/import_get'
require 'swagger_client/models/import_response'
require 'swagger_client/models/info'
require 'swagger_client/models/inline_response_200'
require 'swagger_client/models/list_get'
require 'swagger_client/models/list_post'
require 'swagger_client/models/list_response'
require 'swagger_client/models/model_with_id'
require 'swagger_client/models/newsletter_get'
require 'swagger_client/models/newsletter_post'
require 'swagger_client/models/newsletter_response'
require 'swagger_client/models/newsletter_send'
require 'swagger_client/models/patch_response'
require 'swagger_client/models/recipient_get'
require 'swagger_client/models/recipient_patch'
require 'swagger_client/models/recipient_post'
require 'swagger_client/models/recipient_response'
require 'swagger_client/models/recipient_simple'
require 'swagger_client/models/recipient_subscribe'
require 'swagger_client/models/recipient_subscribe_recipient'
require 'swagger_client/models/recipient_subscribe_response'
require 'swagger_client/models/recipient_subscribe_response_value'
require 'swagger_client/models/recipient_subscribe_response_value_result'
require 'swagger_client/models/recipient_subscribe_response_value_result_error'
require 'swagger_client/models/recipient_subscribe_response_value_result_error_recipients'
require 'swagger_client/models/recipient_subscribe_response_value_result_success'
require 'swagger_client/models/report'
require 'swagger_client/models/report_response'
require 'swagger_client/models/token'
require 'swagger_client/models/user_get'
require 'swagger_client/models/user_patch'
...
require 'swagger_client/api/newsletter_api'
