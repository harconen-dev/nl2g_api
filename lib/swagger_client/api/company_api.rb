...
module SwaggerClient
  class CompanyApi
    ...
    def get_company(opts = {})
      data, _status_code, _headers = get_company_with_http_info(opts)
      return data
    end
    ...
    def get_company_with_http_info(opts = {})
    ...
    def update_company(id, company, opts = {})
      data, _status_code, _headers = update_company_with_http_info(id, company, opts)
      return data
    end
    ...
    def update_company_with_http_info(id, company, opts = {})
      if @api_client.config.debugging
      ...
      fail ArgumentError, "Missing the required parameter 'company' when calling CompanyApi.update_company" if company.nil?
      # resource path
