...
module SwaggerClient
  class ListApi
    ...
    def create_list(list, opts = {})
      data, _status_code, _headers = create_list_with_http_info(list, opts)
      return data
    end
    ...
    def create_list_with_http_info(list, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ListApi.create_list ..."
      end
      # verify the required parameter 'list' is set
      fail ArgumentError, "Missing the required parameter 'list' when calling ListApi.create_list" if list.nil?
      # resource path
    ...
    def delete_list_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling ListApi.delete_list" if id.nil?
      # resource path
      local_var_path = "/lists/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def get_lists_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ListApi.get_lists ..."
      end
      # resource path
      local_var_path = "/lists".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ListApi#get_lists\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_recipients_with_http_info(lid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ListApi.get_recipients ..."
      end
      # verify the required parameter 'lid' is set
      fail ArgumentError, "Missing the required parameter 'lid' when calling ListApi.get_recipients" if lid.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ListApi#get_recipients\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def remove_recipients_from_list_with_http_info(lid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ListApi.remove_recipients_from_list ..."
      end
      # verify the required parameter 'lid' is set
      fail ArgumentError, "Missing the required parameter 'lid' when calling ListApi.remove_recipients_from_list" if lid.nil?
      # resource path
      local_var_path = "/lists/{lid}/recipients".sub('{format}','json').sub('{' + 'lid' + '}', lid.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ListApi#remove_recipients_from_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [PatchResponse]
    def update_list(id, list, opts = {})
      data, _status_code, _headers = update_list_with_http_info(id, list, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PatchResponse, Fixnum, Hash)>] PatchResponse data, response status code and response headers
    def update_list_with_http_info(id, list, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ListApi.update_list ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ListApi.update_list" if id.nil?
      # verify the required parameter 'list' is set
      fail ArgumentError, "Missing the required parameter 'list' when calling ListApi.update_list" if list.nil?
      # resource path
      local_var_path = "/lists/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def update_recipients_with_http_info(lid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ListApi.update_recipients ..."
      end
      # verify the required parameter 'lid' is set
      fail ArgumentError, "Missing the required parameter 'lid' when calling ListApi.update_recipients" if lid.nil?
      # resource path
      local_var_path = "/lists/{lid}/recipients".sub('{format}','json').sub('{' + 'lid' + '}', lid.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :return_type => 'PatchResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ListApi#update_recipients\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
