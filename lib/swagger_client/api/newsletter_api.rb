...
module SwaggerClient
  class NewsletterApi
    ...
    # @param newsletter the data to save
    # @param [Hash] opts the optional parameters
    # @return [ApiResponsePost]
    def create_newsletter(lid, newsletter, opts = {})
      data, _status_code, _headers = create_newsletter_with_http_info(lid, newsletter, opts)
      return data
    end
    ...
    def create_newsletter_with_http_info(lid, newsletter, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NewsletterApi.create_newsletter ..."
      end
      # verify the required parameter 'lid' is set
      fail ArgumentError, "Missing the required parameter 'lid' when calling NewsletterApi.create_newsletter" if lid.nil?
      # verify the required parameter 'newsletter' is set
      fail ArgumentError, "Missing the required parameter 'newsletter' when calling NewsletterApi.create_newsletter" if newsletter.nil?
      # resource path
      local_var_path = "/lists/{lid}/newsletters".sub('{format}','json').sub('{' + 'lid' + '}', lid.to_s)
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(newsletter)
      auth_names = ['OAuth']
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NewsletterApi#create_newsletter\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_newsletter(id, opts = {})
      data, _status_code, _headers = get_newsletter_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :_filter a FIQL-Filter
    # @option opts [Array<String>] :_fields list of case-sensetive fields which should be returned.    Only needed if _expand is false or special attributes are needed
    # @return [Array<(NewsletterResponse, Fixnum, Hash)>] NewsletterResponse data, response status code and response headers
    def get_newsletter_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NewsletterApi.get_newsletter ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling NewsletterApi.get_newsletter" if id.nil?
      # resource path
      local_var_path = "/newsletters/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'NewsletterResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NewsletterApi#get_newsletter\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :_fields list of case-sensetive fields which should be returned.    Only needed if _expand is false or special attributes are needed
    # @return [NewsletterResponse]
    def get_newsletters(lid, opts = {})
      data, _status_code, _headers = get_newsletters_with_http_info(lid, opts)
      return data
    end
    ...
    # @option opts [Array<String>] :_fields list of case-sensetive fields which should be returned.    Only needed if _expand is false or special attributes are needed
    # @return [Array<(NewsletterResponse, Fixnum, Hash)>] NewsletterResponse data, response status code and response headers
    def get_newsletters_with_http_info(lid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NewsletterApi.get_newsletters ..."
      end
      # verify the required parameter 'lid' is set
      fail ArgumentError, "Missing the required parameter 'lid' when calling NewsletterApi.get_newsletters" if lid.nil?
      # resource path
      local_var_path = "/lists/{lid}/newsletters".sub('{format}','json').sub('{' + 'lid' + '}', lid.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'NewsletterResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NewsletterApi#get_newsletters\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_reports_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NewsletterApi.get_reports ..."
      end
      # resource path
      local_var_path = "/lists/{lid}/newsletters/{nid}/aggregations".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NewsletterApi#get_reports\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def send_newsletter(id, newsletter, opts = {})
      send_newsletter_with_http_info(id, newsletter, opts)
      return nil
    end
    ...
    def send_newsletter_with_http_info(id, newsletter, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NewsletterApi.send_newsletter ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling NewsletterApi.send_newsletter" if id.nil?
      # verify the required parameter 'newsletter' is set
      fail ArgumentError, "Missing the required parameter 'newsletter' when calling NewsletterApi.send_newsletter" if newsletter.nil?
      # resource path
      local_var_path = "/newsletters/{id}/send".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NewsletterApi#send_newsletter\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id the id of the newsletter
    # @param newsletter the data to update
    # @param [Hash] opts the optional parameters
    # @return [PatchResponse]
    def update_newsletter(id, newsletter, opts = {})
      data, _status_code, _headers = update_newsletter_with_http_info(id, newsletter, opts)
      return data
    end
    ...
    def update_newsletter_with_http_info(id, newsletter, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NewsletterApi.update_newsletter ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling NewsletterApi.update_newsletter" if id.nil?
      # verify the required parameter 'newsletter' is set
      fail ArgumentError, "Missing the required parameter 'newsletter' when calling NewsletterApi.update_newsletter" if newsletter.nil?
      # resource path
      local_var_path = "/newsletters/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NewsletterApi#update_newsletter\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
