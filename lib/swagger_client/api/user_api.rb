...
module SwaggerClient
  class UserApi
    ...
    def update_user_with_http_info(id, user, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling UserApi.update_user" if id.nil?
      # verify the required parameter 'user' is set
      fail ArgumentError, "Missing the required parameter 'user' when calling UserApi.update_user" if user.nil?
      # resource path
