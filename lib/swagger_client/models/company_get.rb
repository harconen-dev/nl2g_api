...
module SwaggerClient
  ...
  class CompanyGet
    ...
    def self.swagger_types
      {
        ...
        :'state' => :'String',
        :'credits_email' => :'Integer',
        :'credits_freemail' => :'Integer',
        :'credits_abo' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bill_address')
      ...
      if attributes.has_key?(:'default_list_id')
        self.default_list_id = attributes[:'default_list_id']
      end
      ...
      if attributes.has_key?(:'credits_email')
        self.credits_email = attributes[:'credits_email']
      end

      if attributes.has_key?(:'credits_freemail')
        self.credits_freemail = attributes[:'credits_freemail']
      end

      if attributes.has_key?(:'credits_abo')
        self.credits_abo = attributes[:'credits_abo']
      end
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ["verified", "pending", "declided"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          default_list_id == o.default_list_id &&
          state == o.state &&
          credits_email == o.credits_email &&
          credits_freemail == o.credits_freemail &&
          credits_abo == o.credits_abo
    end
    ...
    def hash
      [id, name, address, city, postcode, country, bill_name, bill_first_name, bill_last_name, bill_address, bill_city, bill_postcode, bill_country, default_list_id, state, credits_email, credits_freemail, credits_abo].hash
    end
