...
module SwaggerClient
  ...
  class ImportGet
    ...
    def self.swagger_types
      {
        ...
        :'duplicate_recipients' => :'Array<RecipientSimple>',
        :'invalid_recipients' => :'Array<RecipientSimple>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'count_inserted')
        self.count_inserted = attributes[:'count_inserted']
      end

      if attributes.has_key?(:'count_updated')
        self.count_updated = attributes[:'count_updated']
      end

      if attributes.has_key?(:'count_failed')
        self.count_failed = attributes[:'count_failed']
      end

      if attributes.has_key?(:'duplicate_recipients')
        if (value = attributes[:'duplicate_recipients']).is_a?(Array)
          self.duplicate_recipients = value
        end
      end

      if attributes.has_key?(:'invalid_recipients')
        if (value = attributes[:'invalid_recipients']).is_a?(Array)
          self.invalid_recipients = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          count_inserted == o.count_inserted &&
          count_updated == o.count_updated &&
          count_failed == o.count_failed &&
          duplicate_recipients == o.duplicate_recipients &&
          invalid_recipients == o.invalid_recipients
    end
    ...
    def hash
      [count_inserted, count_updated, count_failed, duplicate_recipients, invalid_recipients].hash
    end
