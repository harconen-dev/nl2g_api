...
module SwaggerClient
  ...
  class NewsletterPost
    ...
    attr_accessor :has_open_tracking

    # weither click_tracking is enabled or not
    attr_accessor :has_click_tracking

    # weither click_tracking is enabled or not
    attr_accessor :has_conversion_tracking
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'has_open_tracking')
        self.has_open_tracking = attributes[:'has_open_tracking']
      end

      if attributes.has_key?(:'has_click_tracking')
        self.has_click_tracking = attributes[:'has_click_tracking']
      end

      if attributes.has_key?(:'has_conversion_tracking')
        self.has_conversion_tracking = attributes[:'has_conversion_tracking']
      end
      ...
      if attributes.has_key?(:'preheader')
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["default", "ab", "trigger", "transaction"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          has_open_tracking == o.has_open_tracking &&
          has_click_tracking == o.has_click_tracking &&
          has_conversion_tracking == o.has_conversion_tracking &&
          json == o.json &&
          html == o.html &&
          text == o.text &&
          subject == o.subject &&
    ...
    def hash
      [type, name, description, has_open_tracking, has_click_tracking, has_conversion_tracking, json, html, text, subject, preheader, header_reply_email, header_reply_name, header_from_email, header_from_name].hash
    end
