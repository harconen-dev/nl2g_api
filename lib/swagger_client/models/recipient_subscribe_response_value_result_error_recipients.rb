...
module SwaggerClient
  ...
  class RecipientSubscribeResponseValueResultErrorRecipients
    ...
    def self.swagger_types
      {
        :'duplicate' => :'Array<RecipientSimple>',
        :'invalid' => :'Array<RecipientSimple>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'duplicate')
        if (value = attributes[:'duplicate']).is_a?(Array)
          self.duplicate = value
        end
      end

      if attributes.has_key?(:'invalid')
        if (value = attributes[:'invalid']).is_a?(Array)
          self.invalid = value
        end
      end
