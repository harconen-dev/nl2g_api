...
module SwaggerClient
  ...
  class Report
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'newsletter_id')
      ...
      if attributes.has_key?(:'mail_count')
        self.mail_count = attributes[:'mail_count']
      end
      ...
      if attributes.has_key?(:'conversions')
        self.conversions = attributes[:'conversions']
      end

      if attributes.has_key?(:'sum_conversions')
        self.sum_conversions = attributes[:'sum_conversions']
      end
      ...
      if attributes.has_key?(:'spam_bounces')
        self.spam_bounces = attributes[:'spam_bounces']
      end
    ...
    def hash
      [newsletter_id, date, mail_count, opens, unique_opens, clicks, unique_clicks, conversions, sum_conversions, unsubscribes, hard_bounces, soft_bounces, spam_bounces].hash
    end
