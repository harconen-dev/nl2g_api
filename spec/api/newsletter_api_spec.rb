...
# Unit tests for SwaggerClient::NewsletterApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewsletterApi' do
  before do
    # run before each test
    @instance = SwaggerClient::NewsletterApi.new
  end
  ...
  describe 'test an instance of NewsletterApi' do
    it 'should create an instact of NewsletterApi' do
      expect(@instance).to be_instance_of(SwaggerClient::NewsletterApi)
    end
  end
  ...
  # unit tests for send_newsletter
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'send_newsletter test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_newsletter
  ...
  describe 'update_newsletter test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
