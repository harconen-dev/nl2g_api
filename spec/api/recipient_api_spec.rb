...
describe 'RecipientApi' do
  ...
  # unit tests for import_recipients_init
  ...
  describe 'import_recipients_init test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for import_recipients_save
  ...
  # @param [Hash] opts the optional parameters
  # @return [ApiResponsePost]
  describe 'import_recipients_save test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for import_recipients_statistics
  # Get statistics about the import by file
  # Get statistics about the import by file.
  # @param id the id of the import job
  # @param [Hash] opts the optional parameters
  # @return [ImportResponse]
  describe 'import_recipients_statistics test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for remove_recipients_from_list
  ...
  # @option opts [String] :_filter a FIQL-Filter
  # @return [PatchResponse]
  describe 'remove_recipients_from_list test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for subscribe_recipient
  ...
  describe 'subscribe_recipient test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_recipient
  ...
  # @param [Hash] opts the optional parameters
  # @return [PatchResponse]
  describe 'update_recipient test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
