...
# Unit tests for SwaggerClient::ApiResponseDelete
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiResponseDelete' do
  before do
    # run before each test
    @instance = SwaggerClient::ApiResponseDelete.new
  end
  ...
  describe 'test an instance of ApiResponseDelete' do
    it 'should create an instact of ApiResponseDelete' do
      expect(@instance).to be_instance_of(SwaggerClient::ApiResponseDelete)
    end
  end
end
