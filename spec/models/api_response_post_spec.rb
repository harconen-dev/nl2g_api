...
# Unit tests for SwaggerClient::ApiResponsePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiResponsePost' do
  before do
    # run before each test
    @instance = SwaggerClient::ApiResponsePost.new
  end
  ...
  describe 'test an instance of ApiResponsePost' do
    it 'should create an instact of ApiResponsePost' do
      expect(@instance).to be_instance_of(SwaggerClient::ApiResponsePost)
    end
  end
