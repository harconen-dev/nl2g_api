...
# Unit tests for SwaggerClient::AttributeGet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AttributeGet' do
  before do
    # run before each test
    @instance = SwaggerClient::AttributeGet.new
  end
  ...
  describe 'test an instance of AttributeGet' do
    it 'should create an instact of AttributeGet' do
      expect(@instance).to be_instance_of(SwaggerClient::AttributeGet)
    end
  end
