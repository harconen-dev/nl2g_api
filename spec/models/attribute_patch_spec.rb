...
# Unit tests for SwaggerClient::AttributePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AttributePatch' do
  before do
    # run before each test
    @instance = SwaggerClient::AttributePatch.new
  end
  ...
  describe 'test an instance of AttributePatch' do
    it 'should create an instact of AttributePatch' do
      expect(@instance).to be_instance_of(SwaggerClient::AttributePatch)
    end
  end
