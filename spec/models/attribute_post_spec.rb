...
# Unit tests for SwaggerClient::AttributePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AttributePost' do
  before do
    # run before each test
    @instance = SwaggerClient::AttributePost.new
  end
  ...
  describe 'test an instance of AttributePost' do
    it 'should create an instact of AttributePost' do
      expect(@instance).to be_instance_of(SwaggerClient::AttributePost)
    end
  end
