...
# Unit tests for SwaggerClient::CompanyGet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyGet' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyGet.new
  end
  ...
  describe 'test an instance of CompanyGet' do
    it 'should create an instact of CompanyGet' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyGet)
    end
  end
  ...
  describe 'test attribute "default_list_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
       validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["verified", "pending", "declided"])
  ...
  describe 'test attribute "credits_email"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "credits_freemail"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "credits_abo"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
