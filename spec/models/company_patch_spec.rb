...
# Unit tests for SwaggerClient::CompanyPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyPatch' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyPatch.new
  end
  ...
  describe 'test an instance of CompanyPatch' do
    it 'should create an instact of CompanyPatch' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyPatch)
    end
  end
