...
# Unit tests for SwaggerClient::CompanyResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyResponse.new
  end
  ...
  describe 'test an instance of CompanyResponse' do
    it 'should create an instact of CompanyResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyResponse)
    end
  end
