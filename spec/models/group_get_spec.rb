...
# Unit tests for SwaggerClient::GroupGet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GroupGet' do
  before do
    # run before each test
    @instance = SwaggerClient::GroupGet.new
  end
  ...
  describe 'test an instance of GroupGet' do
    it 'should create an instact of GroupGet' do
      expect(@instance).to be_instance_of(SwaggerClient::GroupGet)
    end
  end
