...
# Unit tests for SwaggerClient::GroupPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GroupPatch' do
  before do
    # run before each test
    @instance = SwaggerClient::GroupPatch.new
  end
  ...
  describe 'test an instance of GroupPatch' do
    it 'should create an instact of GroupPatch' do
      expect(@instance).to be_instance_of(SwaggerClient::GroupPatch)
    end
  end
