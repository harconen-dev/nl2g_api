...
# Unit tests for SwaggerClient::GroupPost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GroupPost' do
  before do
    # run before each test
    @instance = SwaggerClient::GroupPost.new
  end
  ...
  describe 'test an instance of GroupPost' do
    it 'should create an instact of GroupPost' do
      expect(@instance).to be_instance_of(SwaggerClient::GroupPost)
    end
  end
