...
# Unit tests for SwaggerClient::GroupResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GroupResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::GroupResponse.new
  end
  ...
  describe 'test an instance of GroupResponse' do
    it 'should create an instact of GroupResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::GroupResponse)
    end
  end
