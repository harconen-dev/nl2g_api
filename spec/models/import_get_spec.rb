...
# Unit tests for SwaggerClient::ImportGet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ImportGet' do
  before do
    # run before each test
    @instance = SwaggerClient::ImportGet.new
  end
  ...
  describe 'test an instance of ImportGet' do
    it 'should create an instact of ImportGet' do
      expect(@instance).to be_instance_of(SwaggerClient::ImportGet)
    end
  end
  describe 'test attribute "count_inserted"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "count_updated"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "duplicate_recipients"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "invalid_recipients"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
