...
# Unit tests for SwaggerClient::ImportResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ImportResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::ImportResponse.new
  end
  ...
  describe 'test an instance of ImportResponse' do
    it 'should create an instact of ImportResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::ImportResponse)
    end
  end
