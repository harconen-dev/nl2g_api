...
# Unit tests for SwaggerClient::ListGet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListGet' do
  before do
    # run before each test
    @instance = SwaggerClient::ListGet.new
  end
  ...
  describe 'test an instance of ListGet' do
    it 'should create an instact of ListGet' do
      expect(@instance).to be_instance_of(SwaggerClient::ListGet)
    end
  end
