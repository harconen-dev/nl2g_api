...
# Unit tests for SwaggerClient::ModelWithId
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ModelWithId' do
  before do
    # run before each test
    @instance = SwaggerClient::ModelWithId.new
  end
  ...
  describe 'test an instance of ModelWithId' do
    it 'should create an instact of ModelWithId' do
      expect(@instance).to be_instance_of(SwaggerClient::ModelWithId)
    end
  end
