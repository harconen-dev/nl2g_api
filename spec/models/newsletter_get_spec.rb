...
# Unit tests for SwaggerClient::NewsletterGet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewsletterGet' do
  before do
    # run before each test
    @instance = SwaggerClient::NewsletterGet.new
  end
  ...
  describe 'test an instance of NewsletterGet' do
    it 'should create an instact of NewsletterGet' do
      expect(@instance).to be_instance_of(SwaggerClient::NewsletterGet)
    end
  end
