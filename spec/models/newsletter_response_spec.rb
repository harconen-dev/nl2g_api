...
# Unit tests for SwaggerClient::NewsletterResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewsletterResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::NewsletterResponse.new
  end
  ...
  describe 'test an instance of NewsletterResponse' do
    it 'should create an instact of NewsletterResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::NewsletterResponse)
    end
  end
