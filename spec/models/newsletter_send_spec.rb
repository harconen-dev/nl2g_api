...
# Unit tests for SwaggerClient::NewsletterSend
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewsletterSend' do
  before do
    # run before each test
    @instance = SwaggerClient::NewsletterSend.new
  end
  ...
  describe 'test an instance of NewsletterSend' do
    it 'should create an instact of NewsletterSend' do
      expect(@instance).to be_instance_of(SwaggerClient::NewsletterSend)
    end
  end
