...
# Unit tests for SwaggerClient::PatchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PatchResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::PatchResponse.new
  end
  ...
  describe 'test an instance of PatchResponse' do
    it 'should create an instact of PatchResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::PatchResponse)
    end
  end
