...
# Unit tests for SwaggerClient::RecipientGet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientGet' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientGet.new
  end
  ...
  describe 'test an instance of RecipientGet' do
    it 'should create an instact of RecipientGet' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientGet)
    end
  end
  ...
  describe 'test attribute "is_unsubscribed"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "_custom_attribute_"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "statistic_mails_received"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_mails_opened"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_mails_unique_opened"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_mails_clicked"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_conversions"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_conversions_sum"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_last_mail_action"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_last_mail_received"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_last_mail_opened"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_last_mail_clicked"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_last_mail_converted"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_last_useragent_device"' do
    it 'should work' do
       validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["desktop", "mobile", "tablet"])
       validator.allowable_values.each do |value|
         expect { @instance.statistic_last_useragent_device = value }.not_to raise_error
       end
    end
  end

  describe 'test attribute "statistic_last_useragent_family"' do
    it 'should work' do
       validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["lotus_notes", "apple_mail", "thunderbird", "windows_live_mail", "outlook", "iOS", "Android", "Windows", "else"])
       validator.allowable_values.each do |value|
         expect { @instance.statistic_last_useragent_family = value }.not_to raise_error
       end
    end
  end

  describe 'test attribute "statistic_last_latitude"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_last_longitude"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_last_blacklist_list"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_last_unsubscribe_list"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_last_blacklist_list_reason"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "statistic_last_unsubscribe_list_reason"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
