...
# Unit tests for SwaggerClient::RecipientPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientPatch' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientPatch.new
  end
  ...
  describe 'test an instance of RecipientPatch' do
    it 'should create an instact of RecipientPatch' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientPatch)
    end
  end
