...
# Unit tests for SwaggerClient::RecipientResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientResponse.new
  end
  ...
  describe 'test an instance of RecipientResponse' do
    it 'should create an instact of RecipientResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientResponse)
    end
  end
