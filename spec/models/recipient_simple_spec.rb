...
# Unit tests for SwaggerClient::RecipientSimple
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientSimple' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientSimple.new
  end
  ...
  describe 'test an instance of RecipientSimple' do
    it 'should create an instact of RecipientSimple' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientSimple)
    end
  end
