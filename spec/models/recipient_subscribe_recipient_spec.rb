...
# Unit tests for SwaggerClient::RecipientSubscribeRecipient
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientSubscribeRecipient' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientSubscribeRecipient.new
  end
  ...
  describe 'test an instance of RecipientSubscribeRecipient' do
    it 'should create an instact of RecipientSubscribeRecipient' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientSubscribeRecipient)
    end
  end
