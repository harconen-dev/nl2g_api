...
# Unit tests for SwaggerClient::RecipientSubscribeResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientSubscribeResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientSubscribeResponse.new
  end
  ...
  describe 'test an instance of RecipientSubscribeResponse' do
    it 'should create an instact of RecipientSubscribeResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientSubscribeResponse)
    end
  end
