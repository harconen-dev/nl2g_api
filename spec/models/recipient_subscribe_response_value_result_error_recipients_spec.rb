...
# Unit tests for SwaggerClient::RecipientSubscribeResponseValueResultErrorRecipients
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientSubscribeResponseValueResultErrorRecipients' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientSubscribeResponseValueResultErrorRecipients.new
  end
  ...
  describe 'test an instance of RecipientSubscribeResponseValueResultErrorRecipients' do
    it 'should create an instact of RecipientSubscribeResponseValueResultErrorRecipients' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientSubscribeResponseValueResultErrorRecipients)
    end
  end
