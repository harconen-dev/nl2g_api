...
# Unit tests for SwaggerClient::RecipientSubscribeResponseValueResultError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientSubscribeResponseValueResultError' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientSubscribeResponseValueResultError.new
  end
  ...
  describe 'test an instance of RecipientSubscribeResponseValueResultError' do
    it 'should create an instact of RecipientSubscribeResponseValueResultError' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientSubscribeResponseValueResultError)
    end
  end
