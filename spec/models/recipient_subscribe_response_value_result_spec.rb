...
# Unit tests for SwaggerClient::RecipientSubscribeResponseValueResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientSubscribeResponseValueResult' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientSubscribeResponseValueResult.new
  end
  ...
  describe 'test an instance of RecipientSubscribeResponseValueResult' do
    it 'should create an instact of RecipientSubscribeResponseValueResult' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientSubscribeResponseValueResult)
    end
  end
