...
# Unit tests for SwaggerClient::RecipientSubscribeResponseValueResultSuccess
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientSubscribeResponseValueResultSuccess' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientSubscribeResponseValueResultSuccess.new
  end
  ...
  describe 'test an instance of RecipientSubscribeResponseValueResultSuccess' do
    it 'should create an instact of RecipientSubscribeResponseValueResultSuccess' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientSubscribeResponseValueResultSuccess)
    end
  end
