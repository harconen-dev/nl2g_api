...
# Unit tests for SwaggerClient::RecipientSubscribeResponseValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientSubscribeResponseValue' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientSubscribeResponseValue.new
  end
  ...
  describe 'test an instance of RecipientSubscribeResponseValue' do
    it 'should create an instact of RecipientSubscribeResponseValue' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientSubscribeResponseValue)
    end
  end
