...
# Unit tests for SwaggerClient::RecipientSubscribe
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecipientSubscribe' do
  before do
    # run before each test
    @instance = SwaggerClient::RecipientSubscribe.new
  end
  ...
  describe 'test an instance of RecipientSubscribe' do
    it 'should create an instact of RecipientSubscribe' do
      expect(@instance).to be_instance_of(SwaggerClient::RecipientSubscribe)
    end
  end
