...
# Unit tests for SwaggerClient::UserGet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserGet' do
  before do
    # run before each test
    @instance = SwaggerClient::UserGet.new
  end
  ...
  describe 'test an instance of UserGet' do
    it 'should create an instact of UserGet' do
      expect(@instance).to be_instance_of(SwaggerClient::UserGet)
    end
  end
