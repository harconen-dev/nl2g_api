...
# Unit tests for SwaggerClient::UserPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserPatch' do
  before do
    # run before each test
    @instance = SwaggerClient::UserPatch.new
  end
  ...
  describe 'test an instance of UserPatch' do
    it 'should create an instact of UserPatch' do
      expect(@instance).to be_instance_of(SwaggerClient::UserPatch)
    end
  end
